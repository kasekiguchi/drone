for i = 1:N
    ...
    agent(i).set_property("sensor",Sensor_RangePos(i,'r',1)); % 半径r (第二引数) 内の他エージェントの位置を計測 : sim のみ
    agent(i).set_property("sensor",Sensor_RangeD('r',10)); %  半径r (第二引数) 内の重要度を計測 : sim のみ
