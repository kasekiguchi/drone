...
loadfilename{1} = 'EstimationResult_12state_12_8_Simcirandrevsaddata_est=P2Pshape.mat' ;%mainで書き込んだファイルの名前に逐次変更する
loadfilename{2} = 'EstimationResult_12state_12_8_Simcirandsaddata_est=P2Pshape.mat';
