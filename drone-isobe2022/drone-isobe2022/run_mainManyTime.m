...
% mkdir Data\simData_KoopmanApproach_2023_5_16_newdata2_maxsize; %新規ファイルの作成(以下のファイル名と一致させるように)
% Foldername = 'Data\simData_KoopmanApproach_2023_5_16_newdata2_maxsize'; %ここの名前を変えないとフォルダがどんどん上書きされてしまう
% データ保存先ファイル名
