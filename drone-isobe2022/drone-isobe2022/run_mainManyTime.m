...
mkdir Data\simData_KoopmanApproach_2023_6_6_experiment; %新規フォルダの作成(以下のフォルダ名と一致させるように)
Foldername = 'Data\simData_KoopmanApproach_2023_6_6_experiment'; %ここの名前を変えないとフォルダがどんどん上書きされてしまう
% データ保存先ファイル
