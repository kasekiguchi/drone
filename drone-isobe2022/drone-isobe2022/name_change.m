...
folderPath = 'D:\workspace\GitHub\drone\drone-isobe2022\drone-isobe2022\Data\simData_KoopmanApproach_2023_6_14_experiment_saddleandcircle'; %フォルダの指定
fileList = dir(fullfile(folderPath,'*.mat')); %対象のファイルを取得
loading_filename = 'experiment_6_14_saddleandcircle2'; %変更後のファイル名の指定
