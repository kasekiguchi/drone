...
folderPath = 'C:\Users\kiyam\Documents\卒業研究\GitHub2\drone\drone-isobe2022\drone-isobe2022\Data\simData_KoopmanApproach_2023_10_9_experiment_reverseandorder_circle'; %フォルダの指定(自分のPC)
fileList = dir(fullfile(folderPath,'*.mat')); %対象のファイルを取得
loading_filename = 'experiment_10_10_reverseandorder_circle'; %変更後のファイル名の指定
