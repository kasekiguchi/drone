...
clear all
% close all
% exp1 = load("EstimationResult_12state_2_2_Exp_sprine+cirrevsadP2Pxy_torque_incon_14step分ずらして学習.mat",'est');
% exp1 = load("EstimationResult_12state_2_2_Sim_cirrevsadP2Pxy_torque_incon.mat",'est');
