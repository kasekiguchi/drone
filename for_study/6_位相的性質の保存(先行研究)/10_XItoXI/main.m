...
% skipNN2 = fullyConnectedLayer(2,'Name','skipNN2');
% skipNN3 = fullyConnectedLayer(2,'Name','skipNN3');
% skipNN4 = fullyConnectedLayer(2,'Name','skipNN4');
add = additionLayer(2,'Name','add_1');
lgraph_alpha = addLayers(lgraph_alpha,skipNN);
% lgraph_alpha = addLayers(lgraph_alpha,skipNN2);
% lgraph_alpha = addLayers(lgraph_alpha,skipNN3);
% lgraph_alpha = addLayers(lgraph_alpha,skipNN4);

lgraph_alpha = connectLayers(lgraph_alpha,'InputAlpha','skipNN');

% lgraph_alpha = connectLayers(lgraph_alpha,'skipNN','skipNN2');
% lgraph_alpha = connectLayers(lgraph_alpha,'skipNN2','skipNN3');
% lgraph_alpha = connectLayers(lgraph_alpha,'skipNN3','skipNN4');
