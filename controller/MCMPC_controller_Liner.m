classdef MCMPC_controller_Liner <CONTROLLER_CLASS
    ...
    methods
        function obj = MCMPC_controller_Liner(self, param)
            %-- 変数定義
            obj.self = self;
            %---MPCパラメータ設定---%
            obj.param = param;
        ...
        function [predict_state] = predict(obj)
            ...
            for m = 1:obj.N
                ...
                for h = 1:obj.param.H-1
                    ...
                    % x0 = tmpx(end, :);
                    x0 = obj.param.model.A * x0 + obj.param.model.B*u(:,h,m);
