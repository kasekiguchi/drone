...
ui = CSLC_6_ui(x,xd,R0,R0d,P,K,Pdagger,mui,qid);
b3 = ui./vecnorm(ui,2,1); % 3xN
b1 = xd(4:6) + 1*cell2mat(arrayfun(@(i) Ri(:,:,i)*[1;0;0],1:6,'UniformOutput',false)); % Caution : problem if dx0d = - 10*xi.
...
b2 = b2 ./ si;
b1 = cross(b2, b3);
U= CSLC_6_Uvec(x,xd,P,K,ui,R0,Ri,R0d,qid,b1,b2,b3,si,ci);
end
