function U = CooperativeSuspendedLoadController_3(x_no_q,qi,R0,Ri,R0d,xd,K,P,Pdagger)
...
b2 = b2 ./ si;
b1 = cross(b2, b3);
U= CSLC_3_Uvec(x_no_q,xd,P,K,ui,R0,Ri,R0d,qid,b1,b2,b3,si,ci);
end
