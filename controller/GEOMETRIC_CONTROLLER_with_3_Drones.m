classdef GEOMETRIC_CONTROLLER_with_3_Drones< handle
  ...
  methods
    function obj = GEOMETRIC_CONTROLLER_with_3_Drones(self,param)
      obj.self = self;
      obj.param = param;
...
%       rho4 = obj.param.P(15:17)';
      rho_hat = [Skew(rho1),Skew(rho2),Skew(rho3)];
      P_mat = [eye(3),eye(3),eye(3);rho_hat]; 

      t = varargin{1,1}.t;

      e3 = [0;0;1];
      J0 = diag([obj.param.P(3),obj.param.P(4),obj.param.P(5)]);
      J1 = diag([obj.param.P(21),obj.param.P(22),obj.param.P(23)]);
      J2 = diag([obj.param.P(24),obj.param.P(25),obj.param.P(26)]);
      J3 = diag([obj.param.P(27),obj.param.P(28),obj.param.P(29)]);
...
%       ev0 = model.v - vd;
      ...
      img_mu = blkdiag(Rb0,Rb0,Rb0)*P_mat'*inv(P_mat*P_mat')*con_mat;
...
%       mu4 = model.qi(10:12)*model.qi(10:12)'*img_mu(10:12);
      ...
      mu_sum = mu1+mu2+mu3;
      temp1 = (Skew(rho1)*Rb0'*mu1 +Skew(rho2)*Rb0'*mu2 +Skew(rho3)*Rb0'*mu3);
...
%       M4=- kr/epsilon^2*eRi4 - kO/epsilon*eOi4 + cross(model.Oi(10:12),J1*model.Oi(10:12));
      ...
      obj.result.input = [-f1;M1;-f2;M2;-f3;M3];
