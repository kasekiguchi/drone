...
%             %odeで更新してみる(11/18)
%             [tmpt,tmph]= ode45(@(t,h) obj.A2*h+obj.B2*F1*(z1n-z1-h),[0 dt],obj.h.z1);
%             obj.h.z1 = tmph(end,:)';
%             udu.z1 = [vf(1);(vf(1)-obj.v1p)/dt];
%             [tmpt,tmpeta1]= ode45(@(t,eta1) obj.A2*eta1+obj.B2*F1*(udu.z1-eta1),[0 dt],obj.eta1.z1);
%             obj.eta1.z1 = tmpeta1(end,:)';
%             [tmpt,tmpeta2]= ode45(@(t,eta2) obj.A2*eta2+obj.B2*F1*(z1-eta2),[0 dt],obj.eta2.z1);
%             obj.eta2.z1 = tmpeta2(end,:)';
            %odeここまで
...
% RLS
            ...
            %以前の更新アルゴリズム_εを使用してる
%                 Kz_hat = Kz_hat - (( (obj.G.z1 * obj.h.z1) * epsilon.z1)/(obj.lambda_z+hGh))';
%                 Kz = (1-obj.alpha_z)*Kz + obj.alpha_z*Kz_hat;
%                 obj.G.z1 = (obj.G.z1 -  (obj.G.z1 *obj.h.z1 * obj.h.z1'*obj.G.z1)/(obj.lambda_z+hGh))/obj.lambda_z;
            %最新の更新アルゴリズム_εを使用していない
