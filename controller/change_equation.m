...
function [H, f] = change_equation(Param)
    ...
    Rm = blkdiag(R, R, R, R, R, R, R, R, R, R, R, R, R, R, zeros(4)); %R
    Am = [A; A^2; A^3; A^4; A^5; A^6; A^7; A^8; A^9; A^10; A^11; A^12; A^13; A^14; A^15]; %A
    Qm = blkdiag(CQC, CQC, CQC, CQC, CQC, CQC, CQC, CQC, CQC, CQC, CQC, CQC, CQC, CQC, CQfC); %Q
    qm = blkdiag(QC, QC, QC, QC, QC, QC, QC, QC, QC, QC, QC, QC, QC, QC, QfC); %Q'
