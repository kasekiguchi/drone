...
#define PPM_PERIOD 30000 // PPMの周期判定はHIGHの時間が一定時間続いたら新しい周期の始まりと認知すると予想できるので、22.5より多少短くても問題無い＝＞これにより信号が安定した
...
#define CH_OFFSET 1619       // transmitterシステムでは20が必要　★オフセットには20が追加されているが何故必要であるのかが不明
#define TOTAL_CH_OFFSET 12952 //  8*CH_OFFSET 1フレーム分の合計オフセットを定義
