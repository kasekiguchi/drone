...
#define EM_PIN 3    // 2 or 3のみ　ここでは3ピン(D3)をEM_PINと定義
...
boolean initea = false; //変数boolean fInitialにtrueを格納
/////////////////// PPM関係 ////////////////////
...
volatile uint16_t start_Half = PPM_PERIOD; //16bit整数型(-32768~32767)start_HにPPM_PERIOD(22500)を代入 スタート時のパルス幅
...
void Pulse_control() //★パルスの制御
{
  ...
  else if (digitalRead(OUTPUT_PIN) == HIGH) //2ピンから出力されている出力が5Vの時実行 Lowパルスの制御
  {
