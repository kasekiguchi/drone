...
volatile bool  isEmergency = false; //volatile:変数をレジスタではなくRAMからロードするよう,コンパイラに指示(割り込み関係のコードが関係)　変数isEmergencyにfalseを格納
bool  fReset = false; //変数boolean fResetにfalseを格納
bool  fInitial = true; //変数boolean fInitialにtrueを格納
/////////////////// PPM関係 ////////////////////
...
volatile bool  isReceive_Data_Updated = false; //boolean isReceive_Data_Updatedにfalseを代入
...
*/
      ...
      start_H = REMAINING_W - ( pw[0] + pw[1] + pw[2] + pw[3] + pw[4] + pw[5] + pw[6] + pw[7] ) - 9 * TIME_LOW + 680; //合計5000のとき
