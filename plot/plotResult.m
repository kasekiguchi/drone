...
loadfilename{1} = 'C:\Users\student\Documents\students\komatsu\GitHub_HL\drone\Koopman_data\EstimationResult_12state_11_29_GUIsimdata.mat' ;%mainで書き込んだファイルの名前に逐次変更する
...
%% 誤差の描画
figure(101)
state_p = file{1}.simResult.state.p(:, 1:stepN);
ref_p = file{1}.simResult.reference.est.p(1:stepN,:)';
log_t = file{1}.simResult.T(1:stepN);
plot(log_t, state_p - ref_p)
xlim(xlimHold);
