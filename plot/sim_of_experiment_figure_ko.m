...
load("sl1016hun_sim2_en_Log(16-Oct-2024_18_36_09).mat");
...
takeoff_start_idx = find(log.Data.phase==102, 1, 'first');%テイクオフ開始
flight_start_idx = find(log.Data.phase==102, 1, 'first');%フライト開始
takeoff_finish_idx = find(log.Data.phase==102, 1, 'last');
