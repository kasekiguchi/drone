...
while true
    ...
    Params.Weight.QW = diag([randi(3000);randi(3000); randi(3000); randi(50); randi(50); randi(200)]);   % 姿勢角、角速度

    Params.Weight.Pf = diag([randi(200); randi(200); randi(200)]);                           % 座標終端
    Params.Weight.Vf = diag([randi(200); randi(200); randi(200)]);
    Params.Weight.QWf = diag([randi(4000); randi(4000); randi(4000); randi(50); randi(50); randi(250)]); % 姿勢角終端
    try
