...
for k = 1:kn
    ...
    [K(k),Logger(k)] = Astar_SIR(N,ke,nx,ny,map,unum,E,W,fMethod,Il,vi,fDynamics); % simulation
    %K(k)
end
%%
map.save('Logger_Weight_Astar_100_30_09_004_10_5.mat',Logger);
map.save('K_Weight_Astar_100_30_09_004_10_5.mat',K);
...
%% Astar_SIR
function [k,logger] = Astar_SIR(N,ke,nx,ny,map,unum,E,W,fMethod,Il,vi,fDynamics)
% simulate
% [input]
