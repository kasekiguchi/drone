...
for plot_i = 1:logger.k%変数を格納
    sensor_ofset_z = logger.Data.agent.sensor.result{1,plot_i}.state.p(3) - logger.Data.agent.sensor.result{1,plot_i}.posion(3);
    logger.Data.agent.sensor.result{1,plot_i}.posion(3) = sensor_ofset_z;
