function Estimator = Estimator_NDT(agent, dt, model,output)%,mapname)
...
Estimator.ndt.mapname = "exroom_1.mat";%mapmatchingの時に使う固定マップ※中身はfixedSeg(PointCloud)である必要がある
