   ...
   % Extended Kalman filter
    ...
    methods
        ...
        function [result]=do(obj,varargin)
          ...
          if varargin{1}.t ~= 0
            % 
            % state_pre = [obj.self.estimator.result.state.p;obj.self.estimator.result.state.w;obj.self.estimator.result.state.q;obj.self.estimator.result.state.w];
            % state_nominal = state_pre + obj.JacobianF(state_pre,p)*dt;
