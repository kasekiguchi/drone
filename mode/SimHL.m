...
agent.reference = TIME_VARYING_REFERENCE(agent,{"Case_study_trajectory",{"freq",10,"orig",[0;0;0],"size",[1,1,0]},"HL"});
% agent.reference = TIME_VARYING_REFERENCE(agent,{"Case_study_trajectory",{"freq",0,"orig",[0;0;0],"size",[0,0,0]},"HL"});
