...
initial_state.p = arranged_position([0, 2], 1, 1, 1);% [x, y], 機数，1, z 初期値
...
agent.reference = TIME_VARYING_REFERENCE(agent,{"Case_study_trajectory",{"freq",30,"orig",[0;2;1],"size",[2,2,0]},"HL"});
