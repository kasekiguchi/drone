...
agent.reference = MY_POINT_REFERENCE(agent,{struct("f",[0;0;0.5],"g",[0;0;1],"h",[0;0;0.5],"j",[0;0;1]),20});
...
app.logger.plot({1, "q", "se"},"ax",app.UIAxes2,"xrange",[app.time.ts,app.time.te]);
