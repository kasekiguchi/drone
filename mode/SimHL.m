...
% agent.plant = MODEL_CLASS(agent,Model_EulerAngle_With_Disturbance(dt, initial_state, 1));
...
% agent.estimator = EKF(agent, Estimator_EKF(agent,dt,initial_state,MODEL_CLASS(agent,Model_EulerAngle_With_Disturbance(dt, initial_state, 1)),["p", "q"]));
