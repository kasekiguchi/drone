...
%agent.estimator = EKF(agent, Estimator_EKF(agent,dt,MODEL_CLASS(agent,Model_Suspended_Cooperative_Load(dt, initial_state, 1,N)),["p", "Q","Qi","qi"]));
...
%%
logger.plot({1, "plant.result.state.p", "p"},{1, "input", ""})
function dfunc(app)
