...
agent.parameter = DRONE_PARAM("DIATONE");
    ...
    % agent.parameter = DRONE_PARAM("DIATONE","row","mass",0.6,"lx",0.18,"ly",0.14);%モデル誤差
    agent.parameter = DRONE_PARAM("DIATONE","row","mass",0.5884,"lx",0.16,"ly",0.16);
...
%=====================
% agent.parameter = DRONE_PARAM("DIATONE","model_error",struct("km1",0.5,"mass",0.4,"y",0.04)); 
...
agent.reference = MY_POINT_REFERENCE(agent,{struct("f",[0.2;0;0.5],"g",[0.2;0.2;0.5],"h",[0;0.2;1],"j",[0;0;1],"k",[0.1;0.1;0.8]),3});%縦ベクトルで書く,
