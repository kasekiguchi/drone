...
for i = 1:N
  ...
  agent(i).sensor.rdensity_f = RANGE_DENSITY_FRONT(agent(i),Sensor_RangeD('r',1,'direction_range',[-0.5*pi 0.5*pi])); % range sensor to capture field importance : r : sensor radius
