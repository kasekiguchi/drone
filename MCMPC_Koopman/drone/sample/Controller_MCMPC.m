...
%   詳細説明をここに記述
    ...
    Controller_param.ref_input = [0.269 * 9.81 / 4 0.269 * 9.81 / 4 0.269 * 9.81 / 4 0.269 * 9.81 / 4]'; %初期入力
    Controller_param.model = load('C:\Users\kiyam\Documents\卒業研究\GitHub2\drone\EstimationResult_12state_6_26_circle.mat','est');
...
%     obj.param.QW = diag([10; 10; 10; 0.01; 0.01; 100.0]);  % 姿勢角、角速度
    ...
    %% 重みの設定
    Controller_param.P = diag([500.0; 500.0; 6000.0]);    % 座標   1000 1000 100
