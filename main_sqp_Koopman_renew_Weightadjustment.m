...
while true
    ...
    Params.Weight.QW = diag([randi(3000);randi(3000); randi(3000); randi(100); randi(100); randi(100)]);   % 姿勢角、角速度

    Params.Weight.Pf = diag([randi(300); randi(300); randi(300)]);                           % 座標終端
    Params.Weight.Vf = diag([randi(200); randi(200); randi(200)]);
    Params.Weight.QWf = diag([randi(5000); randi(5000); randi(5000); randi(100); randi(100); randi(300)]); % 姿勢角終端
    try
