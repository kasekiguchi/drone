...
if time.t == 9
    time.t;
        ...
        for i = 1:N
            ...
            param(i).reference.point = {FH, [x; y; z], time.t};
...
%%
%logger.save();
function keep_state(obj)
    obj.state_x = agent.model.state.p(1);
    obj.state_y = agent.model.state.p(2);
    obj.state_yaw = agent.model.state.q(3);
end