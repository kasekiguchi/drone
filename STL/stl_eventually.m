...
% for example  the prosess in [0s,10s]  and you want the speed eventually
...
function result = stl_eventually(data,time,varargin)
...
if varargin(1)<time(1) || varargin{2}>time(length(time))
    ...
    result = any(data(startIdx:endIdx) > varargin(3));
end

end

%%%%%% a given condition will eventually hold true in the future 
