...
%-- 制約
%     initial_state = repmat(agent.estimator.result.state.get(), 1, Params.H);
%     previous_state = [initial_state; zeros(Params.input_size, Params.H)];
%     x = previous_state;
...
function [c, ceq] = Constraints(x, params, Agent, time)
