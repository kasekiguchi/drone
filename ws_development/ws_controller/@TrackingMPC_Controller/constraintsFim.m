function [cineq, ceq] = constraintsFim(obj,x, params)
% モデル予測制御の制約条件を計算するプログラム
%constraints only model
% cineq  = zeros(params.state_size, 2*params.H);
...
cineq = cell2mat(arrayfun(@(L) evFim(1,L) - params.LimFim, 1:params.H, 'UniformOutput', false));
%--------------------------%
