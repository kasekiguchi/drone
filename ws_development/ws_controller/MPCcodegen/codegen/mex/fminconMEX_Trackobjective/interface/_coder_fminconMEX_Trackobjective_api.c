...
static real_T (*b_emlrt_marshallIn(const emlrtStack *sp, const mxArray *x0,
  const char_T *identifier))[77];
static const mxArray *b_emlrt_marshallOut(const real_T u[77]);
static real_T (*c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId))[77];
...
static const mxArray *e_emlrt_marshallOut(const real_T u[77]);
...
static real_T (*n_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId))[77];
...
static void r_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[55]);
  ...
  static const mxArray *b_emlrt_marshallOut(const real_T u[77])
{
  ...
  static const int32_T iv1[2] = { 7, 11 };
...
static const mxArray *d_emlrt_marshallOut(const struct3_T *u)
{
  ...
  static const int32_T iv2[1] = { 77 };

  static const int32_T iv3[1] = { 77 };
...
static const mxArray *f_emlrt_marshallOut(const real_T u[5929])
{
  ...
  static const int32_T iv1[2] = { 77, 77 };
...
static real_T (*n_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId))[77]
{
  static const int32_T dims[2] = { 7, 11 };

  real_T (*ret)[77];
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  ret = (real_T (*)[77])emlrtMxGetData(src);
  emlrtDestroyArray(&src);
  return ret;
}
  static void o_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
...
static void r_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, real_T ret[55])
{
  static const int32_T dims[2] = { 5, 11 };

  real_T (*r)[55];
  int32_T i;
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  r = (real_T (*)[55])emlrtMxGetData(src);
  for (i = 0; i < 55; i++) {
    ret[i] = (*r)[i];
  }
  ...
  const mxArray *plhs[7])
{
  ...
  x = (real_T (*)[77])mxMalloc(sizeof(real_T [77]));
  grad = (real_T (*)[77])mxMalloc(sizeof(real_T [77]));
  hessian = (real_T (*)[5929])mxMalloc(sizeof(real_T [5929]));
