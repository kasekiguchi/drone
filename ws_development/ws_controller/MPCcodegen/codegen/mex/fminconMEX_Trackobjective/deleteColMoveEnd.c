...
static emlrtRSInfo re_emlrtRSI = { 1,  /* lineNo */
  ...
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\optim\\+optim\\+coder\\+QRManager\\deleteColMoveEnd.p"/* pathName */
};
...
static emlrtBCInfo bd_emlrtBCI = { -1, /* iFirst */
  ...
  "C:\\Program Files\\MATLAB\\R2020b\\toolbox\\optim\\+optim\\+coder\\+QRManager\\deleteColMoveEnd.p",/* pName */
  0                                    /* checkKind */
};

/* Function Definitions */
void deleteColMoveEnd(const emlrtStack *sp, g_struct_T *obj, int32_T idx)
{
  emlrtStack b_st;
  emlrtStack st;
  real_T c;
  ...
  if (obj->usedPivoting) {
    ...
    while ((!exitg1) && (i <= obj->ncols)) {
      b_i = obj->jpvt->size[0];
      if ((i < 1) || (i > b_i)) {
        emlrtDynamicBoundsCheckR2012b(i, 1, b_i, &bd_emlrtBCI, sp);
      }
  ...
  if (idx >= obj->ncols) {
    ...
    if ((obj->ncols < 1) || (obj->ncols > b_i)) {
      emlrtDynamicBoundsCheckR2012b(obj->ncols, 1, b_i, &bd_emlrtBCI, sp);
    }

    b_i = obj->jpvt->size[0];
    if ((idx < 1) || (idx > b_i)) {
      emlrtDynamicBoundsCheckR2012b(idx, 1, b_i, &bd_emlrtBCI, sp);
    }
    ...
    for (k = 0; k < i; k++) {
      b_i = obj->QR->size[0];
      if ((k + 1 < 1) || (k + 1 > b_i)) {
        emlrtDynamicBoundsCheckR2012b(k + 1, 1, b_i, &bd_emlrtBCI, sp);
      }
    ...
    if (idx < obj->mrows) {
      ...
      for (k = endIdx; k >= idx; k--) {
        ...
        b_i = obj->QR->size[0];
        if (k > b_i) {
          emlrtDynamicBoundsCheckR2012b(k, 1, b_i, &bd_emlrtBCI, &st);
        }

        b_i = obj->QR->size[1];
        if (idx > b_i) {
          emlrtDynamicBoundsCheckR2012b(idx, 1, b_i, &bd_emlrtBCI, &st);
        }

        d = obj->QR->data[(k + obj->QR->size[0] * (idx - 1)) - 1];
        b_i = obj->QR->size[0];
        if ((k + 1 < 1) || (k + 1 > b_i)) {
          emlrtDynamicBoundsCheckR2012b(k + 1, 1, b_i, &bd_emlrtBCI, &st);
        }
        ...
        b_i = obj->QR->size[0];
        if (k > b_i) {
          emlrtDynamicBoundsCheckR2012b(k, 1, b_i, &bd_emlrtBCI, sp);
        }
