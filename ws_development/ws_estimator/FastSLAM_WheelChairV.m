classdef FastSLAM_WheelChairV < ESTIMATOR_CLASS
    % Particle Filter used SLAM
    % obj = EKF(model,param)
    %   model
    ...
    methods
        function obj = FastSLAM_WheelChairV(self,param)
            obj.self= self;
            model = self.model;
            ...
            obj.particles = Param.particles;%Initial Particles set
        ...
        function [result]=do(obj,param,~)
            ...
            obj.particles = predict_particles(obj.particles, u);
            
            obj.particles = update_with_observation(obj.particles, z);
            
            obj.particles = resampling(obj.particles);
            
            xEst = calc_final_state(obj.particles);
