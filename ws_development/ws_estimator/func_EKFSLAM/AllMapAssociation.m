function parameter = AllMapAssociation(map, ~, state, measured_distance, measured_angle, Constant)
    ...
    cond_1 = (sigma >= 0 & sigma <= 1 & mu >= 0 & mu <= 1 & dist >= 0 & dist <= Constant.SensorRange);
    dist(~cond_1) = inf;
