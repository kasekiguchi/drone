...
H = [O;h];
yh = [x(1:6);y];
matlabFunction(H,'File','JacobH_18_known','vars',{x,[a,b,c,d],param});
matlabFunction(yh,'File','H_18_known','vars',{x,[a,b,c,d],dummy});
...
H = [O;h;];
yh = [x(1:6);y;];
matlabFunction(H,'File','JacobH_12_1','vars',{x,[a,b,c,d],psb,qs,param});
matlabFunction(yh,'File','H_12_1','vars',{x,[a,b,c,d],psb,qs,dummy});
