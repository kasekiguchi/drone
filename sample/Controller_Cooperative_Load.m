...
%%
g1p = lqrd([0,1;0,0],[0;1],diag([5 1.5]),1,dt); % 1 10 1
g1r = lqrd([0,1;0,0],[0;1],diag([1 2]),1,dt); % 1 10 1 : 100 1 0.01
g2 = lqrd([0,1;0,0],[0;1],diag([1.5 2]),1,dt); % 1 1 0.001 : 1 1 1
g3 = lqrd([0,1;0,0],[0;1],diag([1 1.5]),10,dt);%  1 1 50 : 1 10 0.05
...
Controller.gains = [g1p(1)*[1 1 1],g1r(1),g1r(2)*[1 1 1],g1r(2),g2,g3,1];
