...
% g1r = lqrd([0,1;0,0],[0;1],diag([1000 1]),0.01,dt); % 1 10 1 : 100 1 0.01姿勢
% g2 = lqrd([0,1;0,0],[0;1],diag([1 0.1]),1,dt); % 1 1 0.001 : 1 1 1　リンク
% g3 = lqrd([0,1;0,0],[0;1],diag([1 0.001]),1,dt);%  1 1 50 : 1 10 0.05　エージェント

g1p = lqrd([0,1;0,0],[0;1],diag([10 1]),0.01,dt); % 1 10 1
g1r = lqrd([0,1;0,0],[0;1],diag([100 1]),0.01,dt); % 1 10 1 : 100 1 0.01
g2 = lqrd([0,1;0,0],[0;1],diag([1 0.1]),1,dt); % 1 1 0.001 : 1 1 1
g3 = lqrd([0,1;0,0],[0;1],diag([1 0.01]),1,dt);%  1 1 50 : 1 10 0.05
