...
g1p = lqrd([0,1;0,0],[0;1],diag([1 20]),1,dt); % 1 10 1
g1z = lqrd([0,1;0,0],[0;1],diag([1 1]),1,dt); % 1 10 1
g1r = lqrd([0,1;0,0],[0;1],diag([1 10]),0.001,dt); % 1 10 1 : 100 1 0.01
g1rz = lqrd([0,1;0,0],[0;1],diag([1 10]),0.01,dt); % 1 10 1 : 100 1 0.01
g2 = lqrd([0,1;0,0],[0;1],diag([1 1]),10,dt); % 1 1 0.001 : 1 1 1
%g3 = lqrd([0,1;0,0],[0;1],diag([20 1]),10,dt);%  1 1 50 : 1 10 0.05
g3 = lqrd([0,1;0,0],[0;1],diag([10 1]),10,dt);%  1 1 50 : 1 10 0.05
