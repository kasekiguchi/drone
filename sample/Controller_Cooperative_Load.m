...
%%
g1z = lqrd([0,1;0,0],[0;1],diag([1000 10]),1,dt); % 1 10 1
g1p = lqrd([0,1;0,0],[0;1],diag([10 10]),1,dt); % 1 10 1
g1r = lqrd([0,1;0,0],[0;1],diag([1 1]),1,dt); % 1 10 1 : 100 1 0.01
g2 = lqrd([0,1;0,0],[0;1],diag([1 10]),1000,dt); % 1 1 0.001 : 1 1 1
...
Controller.gains = [g1p(1)*[1 1], g1z(1),g1r(1),g1p(2)*[1 1],g1z(2),g1r(2),g2,g3,1];
