function u_trans_param = InputTransform_Thrust2Throttle_drone(varargin)
    ...
    %% transmitter system
    u_trans_param.param.gain = [500; 500; 500; 150]; % serial : 500 = neutral  udp : 1100
    u_trans_param.param.th_offset = 950;             % check throttle at hovering
%     u_trans_param.param.th_offset = 1100;             % check throttle at hovering using dyatone
