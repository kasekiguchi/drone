function Controller = controller_jirei_servo(dt)
%パラメータと構造の橋渡し(FUNCTIONAL_JIREI_SERVO)

Ac2 = [0,1;0,0];
Bc2 = [0;1];
Cc2 = [1 0];
Ac4 = diag([1,1,1],1); %4*4
Bc4 = [0;0;0;1];
Cc4 = [1 0 0 0];
...
Bd1 = [Bd1;0];
Controller_param.Vf = matlabFunction([-sF1*[sz1;x(end)], -sF1*(Ad1-Bd1*sF1)*[sz1;x(end)], -sF1*(Ad1-Bd1*sF1)^2*[sz1;x(end)],...,
    -sF1*(Ad1-Bd1*sF1)^3*[sz1;x(end)]],"Vars",{sz1,sF1,x});
syms sz2 [4 1] real
syms sF2 [1 5] real
syms sz3 [4 1] real
syms sF3 [1 5] real
...
Controller.type="FUNCTIONAL_JIREI_SERVO";
Controller.name="hlc";
