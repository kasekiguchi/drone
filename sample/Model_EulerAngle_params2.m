function Model = Model_EulerAngle_params2(dt, initial, id)
...
Model.name = "euler_params2";                              % print name
Setting.dim = [18, 4, 17];
...
Setting.method = @(t,x,p) [tmpmethod(t,x,p); zeros(6,1)];
Setting.state_list = ["p", "q", "v", "w","ps","qs"];
Setting.initial = initial;                 % struct('p', [0; 0; 0], 'q', [0; 0; 0], 'v', [0; 0; 0], 'w', [0; 0; 0]);
Setting.num_list = [3, 3, 3, 3, 3, 3];
Setting.dt = dt;
Model.param = Setting;
