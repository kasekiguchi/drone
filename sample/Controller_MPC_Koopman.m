...
%   各種値
    ...
    %% 重み
    Controller_param.weight.P = diag([5; 3; 1]);    % 座標   1000 1000 10000
    ...
    Controller_param.weight.QW = diag([2300; 2500; 1200; 1; 1; 1]);  % 姿勢角，角速度

    Controller_param.weight.Pf = diag([10; 10; 1]); % 6
    Controller_param.weight.QWf = diag([3300; 3300; 1200; 1; 1; 1]); % 7,8
