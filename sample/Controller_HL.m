...
%なぶちゃん
Controller.F1=lqrd([0 1;0 0],[0;1],diag([100,1]),[0.1],dt);                                % z 
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([350,500,200,1]),[0.002],dt); % xdiag([100,10,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([350,500,200,1]),[0.002],dt); % ydiag([100,10,10,1])
Controller.F4=lqrd([0 1;0 0],[0;1],diag([100,10]),[0.1],dt);                       % ヨー角 
