...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([350,450,200,1]),[0.006],dt); % xdiag([400,450,150,1]),good([350,450,200,1]),0.01
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([350,450,200,1]),[0.006],dt); % ydiag([400,450,150,1])
% Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([300,100,10,1]),[0.01],dt); % xdiag([100,10,10,1])エーシン
% Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([300,100,10,1]),[0.01],dt); % ydiag([100,10,10,1])エーシン
