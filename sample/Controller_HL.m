...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([350,500,200,1]),0.002,dt); % xdiag hovering([200,200,10,1],0.01)
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([350,500,200,1]),0.002,dt); % ydiag hovering([200,200,10,1],0.01)
