...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([500,1200,200,1]),0.001,dt); % xdiag([100,10,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([500,1200,200,1]),0.001,dt); % ydiag([100,10,10,1])
