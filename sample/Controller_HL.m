...
Controller_param.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([10000,100,10,1]),[0.01],dt); % xdiag([100,10,10,1])
Controller_param.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([10000,100,10,1]),[0.01],dt); % ydiag([100,10,10,1])
