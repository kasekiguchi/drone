...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([400,600,150,1]),0.001,dt); % xdiag hovering([200,200,10,1],0.01)
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([400,600,150,1]),0.001,dt); % ydiag hovering([200,200,10,1],0.01)
