...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([400,450,150,1]),[0.01],dt); % xdiag([100,10,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([400,450,150,1]),[0.01],dt); % ydiag([100,10,10,1])
