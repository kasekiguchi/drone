...
% Controller_param.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([50,40,10,1]),[0.01],dt); % xdiag([100,10,10,1])
% Controller_param.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([50,40,10,1]),[0.01],dt); % ydiag([100,10,10,1])% z 
Controller_param.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([100,80,10,1]),[0.01],dt); % xdiag([100,10,10,1])
Controller_param.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([100,80,10,1]),[0.01],dt); % ydiag([100,10,10,1])
