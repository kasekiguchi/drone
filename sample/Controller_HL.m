...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([4000,6000,1500,10]),0.0001,dt); % xdiag hovering([200,200,10,1],0.01)
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([4000,6000,1500,10]),0.0001,dt); % ydiag hovering([200,200,10,1],0.01)
