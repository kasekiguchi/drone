...
Controller.F2=lqrd(diag([1,1,1],1),[0;0;0;1],diag([100,100,10,1]),0.01,dt); % xdiag hovering([200,200,10,1])
Controller.F3=lqrd(diag([1,1,1],1),[0;0;0;1],diag([100,100,10,1]),0.01,dt); % ydiag hovering([200,200,10,1])
