function u_trans_param_mpc = InputTransform_Thrust2Throttle_drone_MPC(varargin)
    % input transformation from thrust force to throttle level for
    % drone Prop. input

    %% transmitter system
    u_trans_param_mpc.gain =[600;600;600;20]; % gain : [roll pitch yaw throttle]' %不明[850;850;600;600] 4s[700;700;600;400] 複数機[700;700;600;200] 発掘[800;800;800;400]
    u_trans_param_mpc.th_offset = 340;         % offset 3s[1021] 4s[900]　発掘[926]
