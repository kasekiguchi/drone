function Model = typical_Model_PestBirds(id,dt,type,initial,varargin)
...
Setting.method = get_model_name("Pest birds"); % model dynamicsの実体名
Setting.state_list =  ["p","q"];
Setting.initial = initial;%struct('p',[0;0],'q',[0]);
