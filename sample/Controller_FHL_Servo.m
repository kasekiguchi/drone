...
Controller.F1=lqrd([Ac2,zeros(2,1);-Cc2,0],[Bc2;0],diag([100,1,0.1]),0.1,dt);                                % 
...
%
syms x [4 1] real % Model_EulerAngle_Servoを使う前提
syms sz1 [2 1] real
syms sF1 [1 4] real
Ad1 = [Ad1,zeros(2);0,0,1,1;-Cc2,0,1];
Bd1 = [Bd1;0;0];
Controller.F1=lqrd([Ac2,zeros(2);0,0,0,1;-Cc2,0,0],[Bc2;0;0],diag([100,10,1,1]),0.1,dt);
Controller.Vf = matlabFunction([-sF1*[sz1;x(end-1:end)], -sF1*(Ad1-Bd1*sF1)*[sz1;x(end-1:end)], -sF1*(Ad1-Bd1*sF1)^2*[sz1;x(end-1:end)], -sF1*(Ad1-Bd1*sF1)^3*[sz1;x(end-1:end)]],"Vars",{sz1,sF1,x});
