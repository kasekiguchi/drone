...
Controller_param.F2=[lqrd(diag([1,1,1],1),[0;0;0;1],diag([100,10,10,1]),[0.01],dt),-0.9]; % xdiag([100,10,10,1])
Controller_param.F3=[lqrd(diag([1,1,1],1),[0;0;0;1],diag([100,10,10,1]),[0.01],dt),-0.9]; % ydiag([100,10,10,1])
