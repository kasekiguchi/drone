...
Controller_param.F1=lqrd([Ac2,zeros(2,1);-Cc2,0],[Bc2;0],diag([100,100,1]),0.1,dt);                                % 
Controller_param.F2=lqrd([Ac4,zeros(4,1);-Cc4,0],[Bc4;0],diag([1000,10,10,1,0.01]),0.01,dt); % xdiag([100,10,10,1])
Controller_param.F3=lqrd([Ac4,zeros(4,1);-Cc4,0],[Bc4;0],diag([1000,10,10,1,0.01]),0.01,dt); % ydiag([100,10,10,1])
