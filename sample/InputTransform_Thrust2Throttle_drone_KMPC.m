function u_trans_param = InputTransform_Thrust2Throttle_drone_KMPC(varargin)
    ...
    % iflight 6cell
    u_trans_param.gain2 =[1000;1000;1000;100]; %hov,p2p[800,800,800,500]
   % u_trans_param.th_offset2 = 335; %hov,olddata,[1000,1000,1000,100]のとき 適切なオフセット日によるかも
    u_trans_param.th_offset2 = 327.7;
