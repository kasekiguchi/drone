classdef WHILL_EXP_MODEL_Motive < MODEL_CLASS
% Whill 実験用モデル
...
methods
    ...
    function obj = WHILL_EXP_MODEL_Motive(args)
...
%                 obj.result.state.quaternion = [state.pose.orientation.w,state.pose.orientation.x,state.pose.orientation.y,state.pose.orientation.z];
%                 obj.result.state.q = quat2eul(obj.result.state.);
%                 obj.state.p = [state.pose.position.z,state.pose.position.x];
%                 obj.state.quaternion = [state.pose.orientation.w,state.pose.orientation.x,state.pose.orientation.y,state.pose.orientation.z];
%                 obj.state.q = quat2eul(obj.state.qq);
...
%                     obj.result.state.p = [state.pose.position.z,state.pose.position.x];
%                     obj.result.state.quaternion = [state.pose.orientation.w,state.pose.orientation.x,state.pose.orientation.y,state.pose.orientation.z];
%                     obj.result.state.q = quat2eul(obj.result.state.qq);
%                     obj.state.p = [state.pose.position.z,state.pose.position.x];
%                     obj.state.quaternion = [state.pose.orientation.w,state.pose.orientation.x,state.pose.orientation.y,state.pose.orientation.z];
%                     obj.state.q = quat2eul(obj.state.qq);
