function dX = cable_suspended_rigid_body_with_4_drones2(x,u,P)
ddX = ddx0do0_4(x,u,P,inv(Addx0do0_4(x,u,P)));
dX = tmp_cable_suspended_rigid_body_with_4_drones(x,u,P,ddX);
end
%% 状態：
% 牽引物: 位置，姿勢角，速度，角速度，
% リンク: 角度，角速度
