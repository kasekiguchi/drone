...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << dot(x) == ((-x)*x+p+u*u+w);

    OCP ocp1(0, 1, 20);
    ocp1.minimizeMayerTerm((-p*p+pow(q,2.00000000000000000000e+00)+x));
    ocp1.subjectTo(acadodata_f1);
    ocp1.subjectTo(AT_START, x == 1.00000000000000000000e+00);
    ocp1.subjectTo(1.00000000000000005551e-01 <= p <= 2.00000000000000000000e+00);
    ocp1.subjectTo(1.00000000000000005551e-01 <= u <= 2.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000005551e-01) <= w <= 2.10000000000000008882e+00);
